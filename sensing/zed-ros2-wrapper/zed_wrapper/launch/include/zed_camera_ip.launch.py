    ...
    zed_wrapper_node = Node(
        ...
        parameters=[
            ...
            # Overriding
            {
                ...
                "streaming_address": cam_ip,
                "streaming_port": cam_port,
...
def generate_launch_description():
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument("cam_ip", description="The address ip of streaming."),
            DeclareLaunchArgument("cam_port", description="The port of streaming."),
            DeclareLaunchArgument(
                "node_name",
