...
def generate_launch_description():
    ...
    ip = LaunchConfiguration("ip", default="192.168.1.110")
    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument(
                name="ip", default_value="192.168.1.110", description="ip of zed camera"
            ),
            DeclareLaunchArgument(
                name="port",
                default_value="30000",
            ...
            ExecuteProcess(
                cmd=["ros2", "run", "formation_experiment", "test_bash.sh"],
                output="screen",
            ),
        ]
    )
